...
namespace OSM2019.Experiment
{
    class CommonCuriocity_Experiment
    {
        ...
        */
        ...
        public CommonCuriocity_Experiment SetBeliefUpdater(BeliefUpdater belief_updater)
        {
        ...
        public CommonCuriocity_Experiment SetOpinionThreshold(double op_threshold)
        {
